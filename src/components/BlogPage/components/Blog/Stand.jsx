      ...
      <MultiCarousel className={styles.slider}>
        <div className={styles.slide}>
          ...
          <div className={styles.standIntro}>
            ...
            <ul className={styles.introList}>
              <li>publish your post as a blog post and introduce your opinion all of the users</li>
              <li>see top rates publlishers and their blog posts</li>
              <li>take a quick jump into your interest with category shortcuts</li>
        ...
        <div className={styles.slide}>
          ...
          <p className={styles.standAvailability}>
            posts which you will publish as a blog post will be accessable <br /> only on the blog
            page so they not be shown in your friends feed
          </p>
        </div>
        <div className={styles.slide}>
          <Image src='/img/blog-bg-3.jpg' className={styles.sliderBg} />
          <p className={styles.standStatistic}>
            over the <span className={styles.ratingSharp}>1 000 000</span> blog post on the page
