...
import { ArrowDownRectingle, PublicIcon, LockIcon, FriendIcon, GroupIcon } from '../Icons/icons';

function SelectAudience({ handleAudience, audience, isBlogPostAudience = false }) {
    ...
    <div
      ...
      {activateSelection && (
        <div className={styles.audienceSelectionsList}>
          ...
          {isBlogPostAudience && (
            <button name='users' onClick={(e) => handleSelection(e.target.name)}>
